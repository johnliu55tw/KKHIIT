...
module.exports.HiitStateMachine = HiitStateMachine
...
function HiitView () {
  ...
  function setTimerValue (secs) {
    ...
    if (secs === null) {
      ...
      var secPart = secs % 60
      timerValue.textContent = utils.zfill(minPart) + ':' + utils.zfill(secPart)
    }
  }
  ...
  function setSetsValue (remain, total) {
    ...
    if (remain === null) {
      ...
      setsValue.textContent = utils.zfill(remain) + '/' + utils.zfill(total)
    }
  }
